  ...
  return (
    <div>
      <div className="grid shadow-2xl bg-ldgray p-10 lg:px-28 py-8">
        <div className="mx-auto font-audimat py-4 text-2xl md:text-4xl lg:text-6xl text-transparent bg-clip-text bg-gradient-to-br from-ldyellow to-lddblue text-center">
          Welcome to all we do!
        </div>
        <div>
        <p className="mx-auto font-audimat py-4 text-ldgraytext text-2xl">
